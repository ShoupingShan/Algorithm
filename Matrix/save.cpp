...
void Matrix::Divide_and_conquer(int n, Matrix &A, Matrix &B, Matrix &C){
    static Matrix A11(N,0.0);
    static Matrix A12(N,0.0);
    static Matrix A21(N,0.0);
    static Matrix A22(N,0.0);
    static Matrix B11(N,0.0);
    static Matrix B12(N,0.0);
    static Matrix B21(N,0.0);
    static Matrix B22(N,0.0);
    static Matrix C11(N,0.0);
    static Matrix C12(N,0.0);
    static Matrix C21(N,0.0);
    static Matrix C22(N,0.0);
    static Matrix M1(N,0.0);
    static Matrix M2(N,0.0);
    static Matrix M3(N,0.0);
    static Matrix M4(N,0.0);
    static Matrix M5(N,0.0);
    static Matrix M6(N,0.0);
    static Matrix M7(N,0.0);
    static Matrix M8(N,0.0);
    if(n==2){
        multiple(A, B, C);
    }else{
        for(int i=0;i<n/2;i++){
...
void Matrix::Strassen(int n, Matrix &A, Matrix &B, Matrix &C){
    ...
    static Matrix C21(N,0.0);
    static Matrix C22(N,0.0);
    static Matrix AA(N,0.0);
    static Matrix BB(N,0.0);
    static Matrix M1(N,0.0);
    static Matrix M2(N,0.0);
    static Matrix M3(N,0.0);
    static Matrix M4(N,0.0);
